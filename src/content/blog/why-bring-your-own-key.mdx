...
description: "Exploring the privacy, security, and flexibility benefits of the Bring Your Own Key (BYOK) model for AI chat."
pubDate: 2026-06-13
tags: ["BYOK", "privacy", "openrouter"]
---
...
Ready to try it? Get your [OpenRouter API key](https://openrouter.ai/keys), paste it into [ZDR Chat](https://app.zdr.chat), and start chatting. Your key, your models, your privacy.
